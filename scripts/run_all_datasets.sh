...
python -m MERIT.scripts.multi_seed_run \
  ...
  --seeds "$SEEDS" \
  --log_csv results/final_all_datasets/MERIT_apava_results.csv

echo ""
echo "APAVA实验完成！"
echo "结果: results/final_all_datasets/MERIT_apava_results.csv"
...
python -m MERIT.scripts.multi_seed_run \
  ...
  --resolution_list 2,4,6,8 \
  --seeds "$SEEDS" \
  --log_csv results/final_all_datasets/MERIT_ptb_results.csv

echo ""
echo "PTB实验完成！"
echo "结果: results/final_all_datasets/MERIT_ptb_results.csv"
...
python -m MERIT.scripts.multi_seed_run \
  ...
  --resolution_list 2,4,6,8 \
  --seeds "$SEEDS" \
  --log_csv results/final_all_datasets/MERIT_ptbxl_results.csv

echo ""
echo "PTB-XL实验完成！"
echo "结果: results/final_all_datasets/MERIT_ptbxl_results.csv"
